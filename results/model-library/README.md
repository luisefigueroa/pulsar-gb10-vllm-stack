...
automatic rank-2 acquisition, reviewed-manifest hashing, atomic publication,
...
| [`qwen3-1.7b-home-acquisition-gate-20260813.json`](./qwen3-1.7b-home-acquisition-gate-20260813.json) | Three-node reviewed durable-home acquisition: guarded last-home removal, interrupted remote cleanup, explicit and automatic remote placement, full expected-manifest verification, atomic publication, explicit refresh, and final one-home/no-hot inventory | Current catalog/artifact acquisition PASS; serving integration, model qualification, and promotion not run or claimed | Reviewed; site topology, paths, hosts, nodes, plans, and filesystem identity omitted |
