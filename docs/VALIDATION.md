...
guarded reconciliation were implemented later with deterministic coverage, but
the physical duplicate was not removed. It does not claim bit-identical output,
