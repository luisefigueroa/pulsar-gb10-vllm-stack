...
LABEL org.opencontainers.image.title="vllm-gb10" \
      org.opencontainers.image.description="vLLM v0.26.0 for 2x DGX Spark GB10 cluster (sm_121, CUDA 13, aarch64)" \
      org.opencontainers.image.source="claude-fable-vllm-gb10-optimized" \
